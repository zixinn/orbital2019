...
public class PostsAdapterFav extends ArrayAdapter<PostDetails> {
    private final Context context;
    private final List<PostDetails> values;

    public PostsAdapterFav(Context context, List<PostDetails> values) {
        super(context, R.layout.posts_list_row_fav, values);
